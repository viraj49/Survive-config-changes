 ...
 */
public class ConfigChangeFragment extends Fragment implements PullRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        configChangePresenter = new ConfigChangePresenter(configChangeDataSource, rxSchedulerConfiguration, viewState);
    }
    ...
    private void setUpPullToRefresh() {
        ...
        pullToRefreshLayout.setRefreshStyle(PullRefreshLayout.STYLE_RING);
    }
